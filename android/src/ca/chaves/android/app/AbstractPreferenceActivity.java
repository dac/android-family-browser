...
/**
 * {@link PreferenceActivity} base class. All activities in the final application should be derived from this class.
 *
 * @see "http://code.google.com/p/android-family-browser/"
 * @author <a href="mailto:david@chaves.ca">David A Chaves</a>
 */
public abstract class AbstractPreferenceActivity
    ...
    implements Controllable
{
     ...
     */
    protected String tag = Debug.getUniqueTag( AbstractPreferenceActivity.class );
