...
"""
   Create sqlite3 database from source "familyTree.yaml"
"""
...
# AndroidManifest.xml's android:versionCode
APPLICATION_VERSION = os.environ['DROID_APP_VERSION']

# input filename - in current directory
FAMILY_TREE_YAML = 'familyTree.yaml'
# output filename - relative to project's .../tarball directory
FAMILY_TREE_SQLITE = 'databases/v%s.db' % APPLICATION_VERSION
...
ATTRIBUTES = (
    ...
    ( 30, 'baptismdate', u'Baptism', False ),
    ( 31, 'baptismplace', u'At', False ),
...
def get_project_directory():
    ...
    """
    # this function assumes that this script lives in <ProjectDirectory>/share/tools/
    return os.path.normpath(os.path.join(os.path.dirname(__file__), '..', '..', 'main', 'tarball'))

def load_familyTree_dictionary(project_dir):
    """
        load the yaml file into a Python dictionary
    """
    file = os.path.join('.', FAMILY_TREE_YAML)
