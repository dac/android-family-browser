#!/usr/bin/env python
#
# @(#) share/tools/attic.build_drawables.py
#
# @see https://github.com/sole/snippets/blob/master/android/build_drawables.py
# @see http://www.imagemagick.org/discourse-server/viewtopic.php?f=1&t=11979
#
...
def main(argv=None):
    ...
    cwd = os.getcwd()
    input_dir = os.path.join(cwd, 'art')
