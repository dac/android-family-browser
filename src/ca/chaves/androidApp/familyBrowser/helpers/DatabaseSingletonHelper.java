...
/**
 * The class DatabaseSingletonHelper is a SQLiteOpenHelper which tell us if the
 * database was just created in this process. This class is used by class
 * DatabaseSingletonFactory to determine if the database files must be populated
...
class DatabaseSingletonHelper extends SQLiteOpenHelper {
    ...
    /** true if the database was just created in this process */
    ...
    /**
     * Call-back called when the database is being created. Note that the
     * database is created as an empty database, with no tables nor indexes.
     */
    @Override
    ...
    /**
     * Call-back called when a existent database is being upgraded.
     */
    @Override
