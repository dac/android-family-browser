...
/**
 * The class NodeObject stores the attributes, and lists of parents, partners,
 * children and siblings, for a given node_id. *
 * 
...
public class NodeObject {
    ...
    /**
     * The node lists: m_listValues[LIST_ATTRIBUTES] contains the node
     * attributes, m_listValues[LIST_PARENTS] contains the parents, and so on.
     */
