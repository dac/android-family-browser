...
/**
 * The class NodeModel encapsulates the database model used in here. The model
 * consists of two tables, one to store the NodeAttributes instances, and the
 * other to store the NodeObject instances. This class defines and uses many
...
public class NodeModel {
    ...
    /**
     * Create the NodeObject table indexes.
     */
    ...
    /**
     * Query to retrieve the node attributes of a given node_id.
     */
    ...
    /**
     * Query to retrieve the parent node_id(s) of a given node_id. These
    ...
    /**
     * Query to retrieve the partner node_id(s) of a given node_id. These
     * "60,65" are the NODES_COLUMN_ATTRIBUTE_ID(s) for fields "partner",
    ...
    /**
     * Query to retrieve the child node_id(s) of a given node_id. This "90" is
     * the NODES_COLUMN_ATTRIBUTE_ID for field "child" - the source file
    ...
    /**
     * Query to retrieve the sibling node_id(s) of a given node_id. This "91" is
     * the NODES_COLUMN_ATTRIBUTE_ID for field "sibling" - the source file
     * tools/create_familyTree_db.py defines this value.
     */
    ...
    /**
     * Query to retrieve the global node attribute's associated values.
     */
    public static final String SELECT_ATTRIBUTES_SQL = //
    "select " + ATTRIBUTES_COLUMN_ATTRIBUTE_ID + "," + ATTRIBUTES_COLUMN_HIDDEN_FLAG + "," + ATTRIBUTES_COLUMN_TEXT_VALUE + //
